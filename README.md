...
```sh
shasum -a 256 Mac-Explorer-0.1.25-mac-arm64.dmg
```
...
| 从图标识别文件 | PDF 首页缩略图与右下角 PDF 标识，无法预览时显示专用矢量图标；PNG、JPEG、WebP、HEIC、TIFF、GIF、BMP 显示图片缩略图，保留比例与透明度，解码失败时回退到系统图标 |
